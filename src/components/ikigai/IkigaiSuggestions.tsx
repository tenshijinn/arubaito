...
const SuggestionCarousel: React.FC<{
  ...
  return (
    <div className={`relative flex flex-col border ${borderColor} rounded-xl aspect-square p-4`}>
      <span
        className="text-[10px] uppercase tracking-[0.15em] text-primary font-bold"
