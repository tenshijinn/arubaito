...
const Index = () => {
  ...
  return <div className="min-h-screen flex flex-col lg:flex-row font-mono" style={{
    backgroundColor: "hsl(var(--landing-bg))"
  }}>
      {/* LEFT COLUMN - Static */}
      <div className="w-full lg:w-1/2 min-h-screen lg:h-screen lg:sticky lg:top-0 relative flex items-center justify-center overflow-hidden">
        ...
        {hoveredButton === "rei" && <div className="absolute inset-0 w-full h-full" style={{
        backgroundImage: "url(/rei-hover.png)",
        backgroundSize: "cover",
        backgroundPosition: "center"
      }} />}
        ...
        <div className="absolute bottom-8 left-8 flex flex-col gap-4 z-10 w-full max-w-md px-0">
          ...
          <div className="w-full text-left">
            {hoveredButton === "rei" ? <p className="text-sm md:text-base font-mono leading-relaxed" style={{
            ...
            color: "#faf6f4"
              ...
              </p> : hoveredButton === null && <p className="text-sm md:text-base font-mono leading-relaxed" style={{
            fontFamily: "Consolas, monospace",
            color: "#faf6f4"
          }}>
                  <span style={{
              color: "#ed565a"
                  ...
                  <span className="underline">
                    <TextRotator key="default-companies-1" words={companies} isActive={true} delay={0} color="#faf6f4" startIndex={0} />
                  </span>{" "}
                  <span style={{
              color: "#ed565a"
            }}>to</span>
              ...
              color: "#ed565a"
                  ...
                  <span className="underline">
                    <TextRotator key="default-companies-2" words={companies} isActive={true} delay={800} color="#faf6f4" startIndex={10} />
                  </span>{" "}
                  <span className="underline">
          ...
          <div className="flex gap-3 w-full max-w-xs">
            <Button onClick={() => navigate("/arubaito")} variant="outline" size="sm" className="flex-1 text-xs px-3 py-2 border font-mono transition-all duration-300" style={{
            ...
            <Button onClick={() => navigate("/rei")} variant="outline" size="sm" className="flex-1 text-xs px-3 py-2 bg-transparent border font-mono transition-all duration-300" style={{
      ...
      <div className="w-full lg:w-1/2 h-screen overflow-y-scroll snap-y snap-mandatory" style={{
      ...
      scrollSnapStop: "always"
        ...
        <div className="h-screen flex-shrink-0 flex items-center justify-center px-8 md:px-12 lg:px-16 py-16 snap-start">
          <div className="max-w-xl">
            ...
            <iframe src="/ascii/rei.html" className="w-full max-w-md aspect-square mx-auto mb-8 border-0" style={{
            backgroundColor: "transparent"
          }} title="Rei ASCII Art" />
