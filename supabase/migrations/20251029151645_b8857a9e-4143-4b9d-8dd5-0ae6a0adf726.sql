...
-- Anyone can insert their own points record
...
-- Admins can view and manage all points
...
-- Anyone can view treasury balance (public information)
...
-- Only admins can update treasury
